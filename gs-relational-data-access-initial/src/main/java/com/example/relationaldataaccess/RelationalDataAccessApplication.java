...
public class RelationalDataAccessApplication implements CommandLineRunner {
	...
	private void createDB2Connection() {
	...
	public void createTemplateDB() {
		...
		List<Object[]> splitUpNames = Arrays.asList("Joh Woo", "Jeff Dean", "Josh Bloch", "Josh Long").stream()
				.map(name -> name.split(" "))
		...
		log.info("Querying for customer records where first name is 'Josh':");
